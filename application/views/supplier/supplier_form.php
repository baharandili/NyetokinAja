<form action="<?php echo $action; ?>" method="post">
        ...
        <div class="form-group">
            <label for="varchar">Username Supplier <?php echo form_error('username') ?></label>
            <input type="text" class="form-control" name="username" id="username" placeholder="Username Supplier" value="<?php echo $username; ?>" />
        </div>
        <div class="form-group">
            <label for="varchar">Password Supplier <?php echo form_error('password') ?></label>
            <input type="text" class="form-control" name="password" id="password" placeholder="Password Supplier" value="<?php echo $password; ?>" />
        </div>
